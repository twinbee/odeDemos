...
if (wallson) {
    ...
    dGeomSetPosition (wallsG[0], -wal_len/2.0, 15, 0.0);
    dGeomSetPosition (wallsG[1], wal_len/2.0, 15, 0.0);
    dGeomSetPosition (wallsG[2], -wal_len/2.0, -15, 0.0);
    dGeomSetPosition (wallsG[3], wal_len/2.0, -15, 0.0);
    ...
    for (int i = 0; i < n; i++)
    {
     ...
     dBodySetPosition (bods[i], 0.01*xs, 0.01*ys, 0.0);
...
/*
  for (int i = 0; i < n; i++)
  {
   ...
   dBodySetLinearVel (bods[i], -pos_[0]/len, -pos_[1]/len, -pos_[2]/len);
  }
*/
